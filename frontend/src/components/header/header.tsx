...
const Header = ({ user }: { user: UserAuthenticated }) => {
  ...
  return (
    <>
      <header className="will-change-scroll z-50 px-5 lg:px-12 sticky top-0 w-full bg-white py-5 flex justify-between items-center gap-5 border-b shadow-sm">
        <nav className="flex w-full items-center justify-between">
          ...
          <ul className="hidden lg:flex lg:gap-8 lg:font-semibold">
            <li>
          ...
          <ul className="hidden lg:flex">
            <li>
              {user ? (
                ...
                <Button component={Link} href={"/connexion"}>
                  Connexion
                </Button>
              )}
            </li>
