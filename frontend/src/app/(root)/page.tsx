...
const Home: React.FC = () => {
  return (
    <div className="flex relative flex-col gap-20">
      <div className="flex bg-primary rounded-lg py-14 gap-5 md:flex-row md:mx-24 md:my-8 md:justify-around flex-col">
        <div className="flex md:flex-row md:justify-between flex-col items-center gap-4">
          <div className="flex flex-col gap-16">
            <div>
              <p className="mb-4">Bienvenue au pôle de santé de Denain</p>
              <h1 className="font-extrabold md:text-5xl mb-4 bg-secondary py-4 px-6 rounded-md text-darker text-pretty leading-none text-center text-3xl">
      ...
      <div className="flex flex-col gap-5 md:mx-24">
